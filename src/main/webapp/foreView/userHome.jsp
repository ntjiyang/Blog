...
<body>
	<div id="wrapper">
	<iframe name="top" src="foreView/top.jsp" style="width:70%;height:200px;float:right" scrolling="no"></iframe>
     <iframe name="userleft" src="foreView/userleft.jsp" style="width:30%;height:1400px;float:left" scrolling="no"></iframe>
